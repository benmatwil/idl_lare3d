pro plot_model,oModel,theta=theta,phi=phi,psi=psi,scale=scale,shift=shift, $
  ...
  oModel->reset
  ;oModel->translate,-1,-1,-1
  oModel->scale,0.6,0.6,0.6
  oModel->rotate,[1,0,0],120
  oModel->rotate,[0,1,0],-20
  oModel->rotate,[0,0,1],-11.17
